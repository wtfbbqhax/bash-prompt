...
# prompt_is_on_git
  ...
  fixture_dir 'git'
    ...
    prompt_is_on_git || echo '`prompt_is_on_git`; $? != 0 in git directory' 1>&2

  # in a non-git directory
  fixture_dir 'non-git'

    # has a non-zero exit code
    ! prompt_is_on_git || echo '`prompt_is_on_git`; $? == 0 in non-git directory' 1>&2
  ...
  fixture_git_init
    ...
    # has an exit code of 0
    prompt_is_on_git || echo '`prompt_is_on_git`; $? != 0 in git-init directory' 1>&2
...
# prompt_get_git_branch
  ...
  fixture_dir 'branch-master'
    ...
    # is `master`
    test "$(prompt_get_git_branch)" = "master" || echo '`prompt_get_git_branch` !== `master` on a `master` branch' 1>&2

  # on `dev/test` branch
  fixture_dir 'branch-dev'

    # is `dev/test`
    test "$(prompt_get_git_branch)" = "dev/test" || echo '`prompt_get_git_branch` !== `dev/test` on `dev/test` branch' 1>&2

  # off of a branch
  fixture_dir 'branch-non'

    # is 'no branch'
    test "$(prompt_get_git_branch)" = "(no branch)" || echo '`prompt_get_git_branch` !== `(no branch)` off of a branch' 1>&2
  ...
  fixture_git_init
    ...
    # is `master`
    test "$(prompt_get_git_branch)" = "master" || echo '`prompt_get_git_branch` !== `master` in a `git-init` directory' 1>&2
...
# git_status
  ...
  fixture_dir 'unpushed'
    ...
    test "$(prompt_get_git_status)" = "△" || echo '`prompt_get_git_status` !== "△" on an unpushed branch' 1>&2

  # on a dirty and unpushed branch
  fixture_dir 'dirty-unpushed'

    # is a filled up triangle
    test "$(prompt_get_git_status)" = "▲" || echo '`prompt_get_git_status` !== "▲" on a dirty and unpushed branch' 1>&2

  # on an unpulled branch
  fixture_dir 'unpulled'

    # is an empty down triangle
    test "$(prompt_get_git_status)" = "▽" || echo '`prompt_get_git_status` !== "▽" on an unpulled branch' 1>&2
  ...
  fixture_dir 'unpushed-unpulled'
    ...
    # is an empty hexagon
    test "$(prompt_get_git_status)" = "⬡" || echo '`prompt_get_git_status` !== "⬡" on an unpushed and unpulled branch' 1>&2

  # on a dirty, unpushed, and unpulled branch
  fixture_dir 'dirty-unpushed-unpulled'

    # is an filled hexagon
    test "$(prompt_get_git_status)" = "⬢" || echo '`prompt_get_git_status` !== "⬢" on a dirty, unpushed, and unpulled branch' 1>&2
...
# git_progress
  ...
  fixture_dir 'merge-in-progress'
    ...
    test "$(prompt_get_git_progress)" = " [merge]" || echo '`prompt_get_git_progress` !== " [merge]" on a clean merge-in-progress branch' 1>&2
    ...
    cd nested
      ...
      # shows a merge in progress
      test "$(prompt_get_git_progress)" = " [merge]" || echo '`prompt_get_git_progress` !== " [merge]" in a subdirectory of a clean merge-in-progress branch' 1>&2
  ...
  fixture_dir 'am-in-progress'
    ...
    test "$(prompt_get_git_progress)" = " [am]" || echo '`prompt_get_git_progress` !== " [am]" in an am-in-progress repo' 1>&2
  ...
  fixture_dir 'rebase-in-progress'
    ...
    test "$(prompt_get_git_progress)" = " [rebase]" || echo '`prompt_get_git_progress` !== " [rebase]" in a rebase-in-progress repo' 1>&2
  ...
  fixture_dir 'rebase-interactive-in-progress'
    ...
    # shows a `rebase` in progress
    test "$(prompt_get_git_progress)" = " [rebase]" || echo '`prompt_get_git_progress` !== " [rebase]" in a rebase-interactive-in-progress repo' 1>&2
  ...
  fixture_dir 'rebase-merge-in-progress'
    ...
    # shows a `rebase` in progress
    test "$(prompt_get_git_progress)" = " [rebase]" || echo '`prompt_get_git_progress` !== " [rebase]" in a rebase-merge-in-progress repo' 1>&2
  ...
  fixture_dir 'cherry-pick-in-progress'
    ...
    test "$(prompt_get_git_progress)" = " [cherry-pick]" || echo '`prompt_get_git_progress` !== " [cherry-pick]" in a cherry-pick-in-progress repo' 1>&2
  ...
  fixture_dir 'bisect-in-progress'
    ...
    test "$(prompt_get_git_progress)" = " [bisect]" || echo '`prompt_get_git_progress` !== " [bisect]" in a bisect-in-progress repo' 1>&2
  ...
  fixture_dir 'revert-in-progress'
    ...
    test "$(prompt_get_git_progress)" = " [revert]" || echo '`prompt_get_git_progress` !== " [revert]" in a revert-in-progress repo' 1>&2
...
# prompt_get_prompt_symbol
cd "$ORIG_PWD"

  # with a normal user
  bash_symbol="$(bash --norc --noprofile -i -c '. .bash_prompt; echo $(prompt_get_prompt_symbol)')"

    # is $
    test "$bash_symbol" = "$" || echo '`prompt_get_prompt_symbol` !== "$" for a normal user' 1>&2

  # with root
  if which sudo &> /dev/null; then
    bash_symbol="$(sudo bash --norc --noprofile -i -c '. .bash_prompt; echo $(prompt_get_prompt_symbol)')";

    # is #
    test "$bash_symbol" = "#" || echo '`prompt_get_prompt_symbol` !== "#" for root' 1>&2
  else
...
esc=$'\033'
  ...
  TERM=xterm . .bash_prompt
    ...
    expected_prompt='\['$esc'[1m'$esc'[34m\]\u\['$esc'(B'$esc'[m\] \['$esc'[1m'$esc'[37m\]at\['$esc'(B'$esc'[m\] \['$esc'[1m'$esc'[36m\]\h\['$esc'(B'$esc'[m\] \['$esc'[1m'$esc'[37m\]in\['$esc'(B'$esc'[m\] \['$esc'[1m'$esc'[32m\]\w\['$esc'(B'$esc'[m\]$( prompt_is_on_git &&   echo -n " \['$esc'[1m'$esc'[37m\]on\['$esc'(B'$esc'[m\] " &&   echo -n "\['$esc'[1m'$esc'[33m\]$(prompt_get_git_info)" &&   echo -n "\['$esc'[1m'$esc'[31m\]$(prompt_get_git_progress)" &&   echo -n "\['$esc'[1m'$esc'[37m\]")\n\['$esc'(B'$esc'[m\]\['$esc'[1m\]$ \['$esc'(B'$esc'[m\]'
  ...
  TERM="" . .bash_prompt
    ...
    # uses ANSI colors
    expected_prompt='\[\033[1;34m\]\u\[\033[m\] \[\033[1;37m\]at\[\033[m\] \[\033[1;36m\]\h\[\033[m\] \[\033[1;37m\]in\[\033[m\] \[\033[1;32m\]\w\[\033[m\]$( prompt_is_on_git &&   echo -n " \[\033[1;37m\]on\[\033[m\] " &&   echo -n "\[\033[1;33m\]$(prompt_get_git_info)" &&   echo -n "\[\033[1;31m\]$(prompt_get_git_progress)" &&   echo -n "\[\033[1;37m\]")\n\[\033[m\]\[\]$ \[\033[m\]'
  ...
  TERM=xterm-256color PROMPT_USER_COLOR='\033[1;32m' PROMPT_PREPOSITION_COLOR='\033[1;33m' PROMPT_DEVICE_COLOR='\033[1;34m' PROMPT_DIR_COLOR='\033[1;35m' PROMPT_GIT_STATUS_COLOR='\033[1;36m'  PROMPT_GIT_PROGRESS_COLOR='\033[1;37m' PROMPT_SYMBOL_COLOR='\033[1;38m' . .bash_prompt
    ...
    # use the new colors
    expected_prompt='\[\033[1;32m\]\u\['$esc'(B'$esc'[m\] \[\033[1;33m\]at\['$esc'(B'$esc'[m\] \[\033[1;34m\]\h\['$esc'(B'$esc'[m\] \[\033[1;33m\]in\['$esc'(B'$esc'[m\] \[\033[1;35m\]\w\['$esc'(B'$esc'[m\]$( prompt_is_on_git &&   echo -n " \[\033[1;33m\]on\['$esc'(B'$esc'[m\] " &&   echo -n "\[\033[1;36m\]$(prompt_get_git_info)" &&   echo -n "\[\033[1;37m\]$(prompt_get_git_progress)" &&   echo -n "\[\033[1;33m\]")\n\['$esc'(B'$esc'[m\]\[\033[1;38m\]$ \['$esc'(B'$esc'[m\]'
